...
const images = [
  ...
  { src: gallery18, alt: "Students reading in the library" },
  { src: gallery19, alt: "Students engaged in a classroom session" },
  { src: gallery20, alt: "Facilitator leading a reading session" },
  { src: gallery21, alt: "Student in school uniform" },
  { src: gallery22, alt: "Student reading aloud in class" },
  { src: gallery23, alt: "Young child reading a book" },
  { src: gallery24, alt: "Child reading at a desk" },
  { src: gallery25, alt: "Students reading together" },
  { src: gallery26, alt: "Empowering Minds Through Reading group photo" },
];
