...
const stats = [ { icon: Users, value: "200+", label: "Children Supported" }, 
               ...
               { icon: Lightbulb, value: "3+", label: "Digital Skills" }, 
...
const Index = () => ( <div> {/* Hero */} 
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden"> 
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl animate-fade-up"> 
            ...
            <p className="text-primary-foreground/90 text-lg md:text-xl mb-8 max-w-2xl mx-auto"> Benevolence is Love is a youth-led organisation committed to expanding educational opportunities for vulnerable children and empowering young people to build brighter futures for themselves and their communities. </p>
